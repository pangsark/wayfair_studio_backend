...
def get_text(image_path):
    input = {
        "prompt": "Give a textual description of the procedur and objects on this furniture assembly manual page. If the objects are labeled, use their label. Otherwise, attempt to identify them.",
        "system_prompt": "You are an expert in furnature assembly manuals. You give descriptive explanations.",
...
def get_checklist(image_path):
    description = get_text(image_path)

    prompt = f"From this textual description of an assembly manual page, create a checklist of actions to follow on this assembly step. Assembly manual page also attached. ONLY return a bullet-point checklist. \n\nTextual Description: {description}"
